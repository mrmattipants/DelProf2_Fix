...
This Fix is based on the Solutions provided in the Comments Section of the Official DelProf2 Site as well as in the Comment of the following Microsoft Tech Community Discussion Board Posting (the majority of which, can be found in the Comments Located on the 2nd and 3rd Pages).
